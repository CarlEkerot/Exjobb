...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\linewidth]{ransac}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{dbscan_dns}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{const_one}
...
the messages we observe. By looking at the byte value probability
...
\begin{enumerate}
    \item A true protocol constant. These are fields that are defined to be
        ...
        the protocol field in SMB2, which is a four-byte constant field with
        the value \verb+SMB2+.
    ...
    \item A field which is constant in the dump scope. For example, if a dump
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{flag}
    \caption{Caption.}
    \label{fig:flag}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{uniform}
    \caption{Caption.}
    \label{fig:uniform}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{number}
    \caption{Caption.}
    \label{fig:number}
\end{figure}
