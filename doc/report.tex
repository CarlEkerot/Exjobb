...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{0.55\textwidth}
        \begin{tabular}{| c | c | c | c | c | c | c | c | c |}
            ...
            C & -5 & -3 & 0 & 3 & 6 & 7 &\cellcolor[gray]{0.9}8 &
            \cellcolor[gray]{0.9}7 \\ \hline
        \end{tabular}
        \caption{The alignment matrix for the two sequences ACTTGC and
        ATTCGCT.}
        \label{fig:nwmatrix}
    \end{subfigure}
...
\begin{figure}[h]
    \centering
    \texttt{ACTT-GC-\\A-TTCGCT}
    \caption{The resulting alignment of the sequences ACTTGC and ATTCGCT.}
    \label{fig:align}
\end{figure}
