...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \begin{bytefield}[bitwidth=0.5em]{32}
            ...
            \bitbox{8}{F}       % Flags
            \bitbox{16}{F}\\    % Flags2
            \bitbox{16}{SC}     % PID High
            \bitbox{16}{SC}\\   % SecurityFeatures
            \wordbox{1}{...}\\  % (continuation)
            \bitbox{16}{...}    % (continuation)
            \bitbox{16}{C}\\    % Reserved
            \bitbox{16}{D}      % Tree ID
            \bitbox{16}{SC}\\   % PID Low
            \bitbox{16}{D}      % User ID
            \bitbox{16}{SI}     % Multiplex ID
        \end{bytefield}
...
\begin{figure}
    ...
    \begin{bytefield}{32}
        ...
        \bitbox{16}{N}      % Num seconds
        \bitbox{16}{F}\\    % Flags
        \wordbox{1}{D}\\    % Client IP
        \wordbox{1}{D}\\    % Your IP
        \wordbox{1}{D}\\    % Server IP
        \wordbox{1}{D}\\    % Gateway IP
        \wordbox{1}{D}\\    % Client HW Addr
        \bitbox{16}{...}    % (continuation)
        \bitbox{16}{C}\\    % Padding
        \wordbox{1}{C}\\    % Padding
        \wordbox{1}{C}\\    % Padding
        \wordbox[]{1}{\vdots}\\    % Padding
        \wordbox{1}{C}\\    % Padding
    \end{bytefield}
    \captionsetup{width=0.8\textwidth}
